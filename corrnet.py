...
def train():
    ...
    for epoch in range(0, n_epochs + 1):
        self.corrnet_model,self.resnet_model=train_epoch(self.corrnet_model,self.trainLoader,self.resnet_model,self.cosine_sim,optimizer,epoch,print_freq,wandb)
...
def evaluate(retrieval_type,random_seed):
    ...
    retreival_indexes=get_retrievals(retreival_loader,retreival_df,annoy_index,corrnet_model,resnet_model,retrieval_type)    
